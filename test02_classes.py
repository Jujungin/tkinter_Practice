...
#########################
# test class LabelInput #
#########################
# reference : https://python-course.eu/tkinter/labels-in-tkinter.php


# root = tk.Tk()
# li1 = LabelInput(root, 'Name', tk.Entry, {'bg' : 'white', 'fg': 'light green', 'font': 'Verdana 10 bold'})
# li1.grid()

# age_var = tk.IntVar(root, value = 21)
# li2 = LabelInput(
#     root, 'Age', tk.Spinbox,
#     {'textvariable': age_var, 'from': 10, 'to': 150}
# )
# li2.grid()
